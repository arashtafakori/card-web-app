...
import CreateBooklet from './CreateBooklet';
  ...
  return (
    <>
          ...
          >
            {
              bookletsListState.data?.items.map((booklet, itemIndex) => (
                <BookletItem itemIndex={itemIndex} booklet={booklet} key={booklet.id} />))
            }
          </InfiniteScroll>
        </Container>
      </div>
      ...
      >
        ...
        <Modal.Body>
          <CreateBooklet onHide={handleNewItemModelClose}></CreateBooklet>
        </Modal.Body>
      </Modal>
...
export default ShowBookletsList;
